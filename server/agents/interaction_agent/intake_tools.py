        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "preference": {"type": "string", "description": "The caller's requested day and/or time, passed as close to verbatim as possible (e.g. 'Tuesday at 4pm', 'mornings', 'after 3pm'). Always pass this when the caller states any day or time preference."},
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "patient_email": {"type": "string", "description": "Patient email (from their record's email_on_file, or ask). When provided they receive a calendar invite for the appointment."},
                },
